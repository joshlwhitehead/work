...
def heating(folder,alpha,p):                                                                          #funtion to analyze heating data
    ...
    for i in os.listdir(folder):
        ...
        means.append(np.mean(derivTotH))
        stdev.append(np.std(derivTotH))
...
def cooling(folder,alpha,p):                                                  #function to analyze cooling data
    ...
    for i in os.listdir(folder):
        ...
        means.append(np.mean(derivTotC))
        stdev.append(np.std(derivTotC))
