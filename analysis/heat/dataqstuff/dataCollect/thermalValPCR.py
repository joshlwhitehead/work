...
def DV(temp):
    alpha = 0.05
    total = dat.DV
    instListShort = [6,7,10,13,15,25,27]
    instList = instListShort*3
    instList.sort()
    cupList = [8,8,8,8,8,8,10,10,10,5,5,5,5,5,5,8,8,8,8,8,8]
    cupListClump = [8,8,10,5,5,8,8]
    date = [1011,1011,1011,1012,1012,1012,1102,1102,1102,1018,1018,1018,1017,1017,1017,1020,1020,1020,1021,1021,1021]
