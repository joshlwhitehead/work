...
def parsPCRTxt(file):                                                                                                       #read PCR data
    ...
    return (heat,timeH),(cool[1:],timeC[1:]),(denatTemp,annealTemp)             #return heating temps and times, cooling temps and times, and the set temps for denature and anneal
...
# print(parsPCRTxt('data\proposedModel_Adv15_wxx_120123_Run2.txt')[0][0])